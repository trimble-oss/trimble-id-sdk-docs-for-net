...
namespace AuthorizationCodeGrantTypeSample
{
    class Program
    {

        // This sample demonstrates how to use the Authorization Code grant type to authenticate with Trimble Identity
        ...
        static async Task Main(string[] args)
        {
            ...
            _tokenProvider = new AuthorizationCodeGrantTokenProvider(_endpointProvider, configuration["CLIENT_ID"], REDIRECT_URI)
                .WithConsumerSecret(configuration["CLIENT_SECRET"])
